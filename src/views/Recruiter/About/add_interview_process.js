...
const AddInterviewProcess = ({theTrigger, user_id}) => {
  ...
  const validationSchema = yup.object().shape({
    interview_process: yup.string().max(1024, "You should not exceed 1024 character")
  })
              ...
              <Modal.Content>
                <Form>
                  <Form.TextArea
                    ...
                    placeholder="Write about your company interview process"
...
export default AddInterviewProcess